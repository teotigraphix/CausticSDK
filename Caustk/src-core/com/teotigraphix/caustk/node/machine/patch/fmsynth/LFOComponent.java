 ...
 * @since 1.0
 */
public class LFOComponent extends MachineComponent {
    ...
    /**
     * @param index (0,1,2)
     * @see FMSynthMessage#LFO_F1
     * @see FMSynthMessage#LFO_F2
     * @see FMSynthMessage#LFO_F3
     */
    ...
    /**
     * @param index (0,1,2)
     * @see FMSynthMessage#LFO_A1
     * @see FMSynthMessage#LFO_A2
     * @see FMSynthMessage#LFO_A3
     */
