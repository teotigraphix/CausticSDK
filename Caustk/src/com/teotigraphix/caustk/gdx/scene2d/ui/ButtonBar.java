...
public class ButtonBar extends UITable {
    ...
    private ButtonGroup<ToggleButton> group;

    public ButtonGroup<ToggleButton> getGroup() {
        return group;
    }
    ...
    private void refreshButtons() {
        ...
        group = new ButtonGroup<ToggleButton>();
    ...
    protected TextButton createButton(int index, TextButtonStyle style) {
        ...
        button.addListener(new InputListener() {
            ...
            public void enter(InputEvent event, float x, float y, int pointer, Actor fromActor) {
                pendingTipIndex = group.getButtons().indexOf(
                        (ToggleButton)event.getListenerActor(), true);
