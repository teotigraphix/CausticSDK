 ...
 * <p>
 * The knob dispatches a
 * {@link com.badlogic.gdx.scenes.scene2d.utils.ChangeListener.ChangeEvent} when
 * the value changes.
 * 
...
public class Knob extends UITable {
    ...
    public Knob(float min, float max, float stepSize, Skin skin, String styleName) {
        super(skin);
        minValue = min;
        maxValue = max;
