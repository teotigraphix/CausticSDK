...
public abstract class SceneComponent implements ISceneComponent {
    ...
    /**
     * Sets the {@link com.teotigraphix.caustk.gdx.app.IScene} owning scene.
     * 
     * @param scene The mediator's owner.
     * @see #onSceneChange(com.teotigraphix.caustk.gdx.app.IScene)
     */
    ...
    /**
     * Called when {@link #setScene(com.teotigraphix.caustk.gdx.app.IScene)}'s
     * value has changed.
     * 
     * @param screen The new {@link com.teotigraphix.caustk.gdx.app.IScene}.
     */
