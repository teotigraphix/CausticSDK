...
/**
 * A {@link CaustkTriggerMap} holds all {@link Trigger} instances for a
 * {@link Phrase} with the key being the trigger's start beat.
 */
public class CaustkTriggerMap {
    ...
    public CaustkTriggerMap() {
    }

    public CaustkTriggerMap(CaustkPhrase phrase) {
        this.phrase = phrase;
    }
     ...
     * @param velocity The note velocity.
     * @param flags The accent, slide flags.
     * @see CaustkTriggerMap#addNote(int, float, float, float, int)
     */
