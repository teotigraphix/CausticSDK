...
public class CombFilterEffect extends EffectNode {
    ...
    /**
     * @see com.teotigraphix.caustk.core.osc.EffectControls#CombFilter_Freq
     */
    public int getFreq() {
        return freq;
    }
    ...
    /**
     * @see com.teotigraphix.caustk.core.osc.EffectControls#CombFilter_Reso
     */
    ...
    /**
     * @see com.teotigraphix.caustk.core.osc.EffectControls#CombFilter_Wet
     */
    public float getWet() {
        return wet;
    }
    ...
    public CombFilterEffect(Machine machineNode, int slot) {
