 ...
 */
public class HarmonicsComponent extends MachineChannel {
     ...
     * @param tableIndex The harmonic table index (0,1).
     * @param index The harmonic index (0..23).
     * @see com.teotigraphix.caustk.core.osc.PadSynthMessage#QUERY_HARMONICS
     */
     ...
     * @see com.teotigraphix.caustk.core.osc.PadSynthMessage#HARMONICS
     */
     ...
     * 
     * @param tableIndex The harmonic table index (0,1).
     * @see com.teotigraphix.caustk.core.osc.PadSynthMessage#QUERY_WIDTH
     */
