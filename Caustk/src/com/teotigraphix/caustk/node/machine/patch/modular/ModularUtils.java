...
public class ModularUtils {
    ...
    private static Map<ModularComponentType, Map<IModularComponentControl, ModularControl>> map = new HashMap<ModularMessage.ModularComponentType, Map<IModularComponentControl, ModularControl>>();
