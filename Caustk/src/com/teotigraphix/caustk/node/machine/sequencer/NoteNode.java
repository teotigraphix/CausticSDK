...
public class NoteNode extends NodeBase {
     ...
     * 
     * @see com.teotigraphix.caustk.node.machine.sequencer.NoteNode.NoteFlag#None
     * @see com.teotigraphix.caustk.node.machine.sequencer.NoteNode.NoteFlag#Slide
     * @see com.teotigraphix.caustk.node.machine.sequencer.NoteNode.NoteFlag#Accent
     */
    public int getFlags() {
        return flags;
    }
     ...
     * @see com.teotigraphix.caustk.core.osc.PatternSequencerMessage#QUERY_NOTE_DATA
