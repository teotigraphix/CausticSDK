...
public class BasslineMessage extends CausticMessage {
    ...
    public enum Osc1Waveform {
         ...
         * {@link com.teotigraphix.caustk.core.osc.BasslineMessage.Osc1Waveform}
         * .
         */
        public int getValue() {
            return value;
    ...
    public enum LFOTarget {
        ...
        /**
         * Returns a
         * {@link com.teotigraphix.caustk.core.osc.BasslineMessage.LFOTarget}
         * based off the passed integer type.
         * 
         * @param type The int type.
         */
        ...
        /**
         * @see com.teotigraphix.caustk.core.osc.BasslineMessage.LFOTarget#toType(Integer)
         */
