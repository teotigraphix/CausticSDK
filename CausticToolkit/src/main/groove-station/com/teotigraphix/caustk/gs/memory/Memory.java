...
public abstract class Memory {
    ...
    protected GrooveMachine machine;
    ...
    public Memory(GrooveMachine machine, Type type) {
     ...
     * 
     * @param index The index (0-63) of the pattern. Note, the linear value must
    ...
    Phrase getPhrase(Part part) {
        ...
        //
        //        UUID id = libraryPattern.getPhrase(index);
        //        libraryPhrase = getCurrentLibrary().findPhraseById(id);
    ...
    Patch getPatch(Part part) {
        ...
        //                    .get(index).getPatchId();
        //            item = getCurrentLibrary().findPatchById(patchId);
        //        } else {
