...
public class BasslineMachineSound extends MachineSound {
    ...
    protected MemorySlotItem createPhraseInitData() {
        ...
        sb.append(new Note(0f, 60, 1f, 0.25f, 0).serialze());
        sb.append("|");
        sb.append(new Note(1f, 60, 1f, 1.25f, 0).serialze());
        sb.append("|");
        sb.append(new Note(2f, 60, 1f, 2.25f, 0).serialze());
        sb.append("|");
        sb.append(new Note(3f, 60, 1f, 3.25f, 0).serialze());
