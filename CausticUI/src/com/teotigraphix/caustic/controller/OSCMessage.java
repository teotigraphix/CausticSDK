...
public class OSCMessage {
    ...
    public OSCMessage(String device, String control, Object... args) {
        this.device = device;
        this.control = control;
        for (Object arg : args) {
            add(arg);
    ...
    public String toString() {
        ...
        result.append(CoreConstants.FS);
        result.append(mController != null ? mController : CausticEngine.ENGINE_NAME);
        result.append(CoreConstants.FS);
        ...
        if (data != null) {
            result.append(CoreConstants.SPACE);
            result.append(data);
        }
    ...
    public static OSCMessage initialize(String message) {
        ...
        String base = t.nextToken(CoreConstants.FS);
        String device = t.nextToken(CoreConstants.FS);
        String control = t.nextToken(CoreConstants.FS);
    ...
    public final static OSCMessage create(String device, String control) {
        return new OSCMessage(device, control);
    }
    ...
    public final static OSCMessage create(String control) {
        return new OSCMessage(control, null);
    }
}
