...
public class MainLayout extends LinearLayout {
    ...
    ITouchService mTouchService;

    public final ITouchService getTouchService() {
        return mTouchService;
    }

    public final void setTouchService(ITouchService touchService) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        return mTouchService.onInterceptTouchEvent(this, event);
    }

    @Override
    public boolean onTouchEvent(MotionEvent event) {
        return mTouchService.onTouchEvent(this, event);
    }
}
