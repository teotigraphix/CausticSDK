...
public class Knob extends Slider {
    ...
    private void init() {
        ...
        // XXX This was in TX101
        //		mBackground = BitmapFactory.decodeResource(getContext().getResources(),
        //				R.drawable.dail1_background);

        //		mForeground = BitmapFactory.decodeResource(getContext().getResources(),
        //				R.drawable.dail1_foreground);
    ...
    protected void createChildren() {
        ...
        setTrackBackgroundDrawable(resources.getDrawable(R.drawable.dail_background));
        setTrackDrawable(null);
        setThumbDrawable(resources.getDrawable(R.drawable.dail_foreground));
    }
