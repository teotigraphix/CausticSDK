...
public interface ICausticEngine extends ICausticEngineLifesCycle {
    ...
    /**
     * Adds a {@link CausticEventListener} event listener.
     * 
     * @param l The listener.
     */
    void addCoreEventListener(CausticEventListener l);

    /**
     * Removes a {@link CausticEventListener} event listener.
     * 
     * @param l The listener.
     */
    void removeCoreEventListener(CausticEventListener l);

    /**
     * Sets the {@link OnOSCMessageListener}.
     * 
     * @param l The listener.
     */
    void setOnOSCMessageListener(OnOSCMessageListener l);
