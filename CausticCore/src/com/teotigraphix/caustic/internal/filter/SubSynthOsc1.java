...
public class SubSynthOsc1 extends OscillatorComponent implements ISubSynthOsc1 {
    ...
    public float getBend(boolean restore) {
        return SubSynthOscMessage.OSC_BEND.query(getEngine(), getMachineIndex());
    }
    ...
    public Waveform getWaveform(boolean restore) {
        return Waveform.toType(SubSynthOscMessage.OSC1_WAVEFORM.query(getEngine(),
                getMachineIndex()));
    }
    ...
    public void setWaveform(Waveform value) {
        if (value == mWaveform)
            return;
        mWaveform = value;
        SubSynthOscMessage.OSC1_WAVEFORM.send(getEngine(), getMachineIndex(), mWaveform.getValue());
    }
