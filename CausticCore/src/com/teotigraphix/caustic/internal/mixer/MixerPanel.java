        ...
        OnMachineChangeListener
{
    ...
    public void setBass(int index, float value)
    {
        ...
        if (value < -1f || value > 1f)
            throw newRangeException(BASS, "-1.0..1.0", value);
        info.bass = value;
        MixerMessage.EQ_BASS.send(getEngine(), getDeviceId(index), value);
    }
    ...
    public void setMid(int index, float value)
    {
        ...
        if (value < -1f || value > 1f)
            throw newRangeException(MID, "-1.0..1.0", value);
        info.mid = value;
        MixerMessage.EQ_MID.send(getEngine(), getDeviceId(index), value);
    }
    ...
    public void setHigh(int index, float value)
    {
        ...
        if (value < -1f || value > 1f)
            throw newRangeException(HIGH, "-1.0..1.0", value);
        info.high = value;
        MixerMessage.EQ_HIGH.send(getEngine(), getDeviceId(index), value);
    }
    ...
    public void setDelaySend(int index, float value)
    {
        ...
        info.delay = value;
        MixerMessage.DELAY_SEND.send(getEngine(), getDeviceId(index), value);
    }
    ...
    public void setReverbSend(int index, float value)
    {
        ...
        info.reverb = value;
        MixerMessage.REVERB_SEND.send(getEngine(), getDeviceId(index), value);
    }
    ...
    public void setPan(int index, float value)
    {
        ...
        info.pan = value;
        MixerMessage.PAN.send(getEngine(), getDeviceId(index), value);
    }
    ...
    public void setStereoWidth(int index, float value)
    {
        ...
        MixerMessage.STEREO_WIDTH.send(getEngine(), getDeviceId(index), value);
    }
    ...
    public void setVolume(int index, float value)
    {
        ...
        if (value < 0f || value > 2f)
            throw newRangeException(VOLUME, "0.0..2.0", value);
        info.volume = value;
        MixerMessage.VOLUME.send(getEngine(), getDeviceId(index), value);
    }
