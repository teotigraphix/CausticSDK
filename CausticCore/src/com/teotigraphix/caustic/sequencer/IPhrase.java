...
public interface IPhrase extends IPersist, IRestore
{
    ...
    /**
     * Returns the id of the {@link IPhrase} which is the String representation
     * of the bank and pattern such as <code>A01</code> or <code>D11</code>.
     * <p>
     ...
     * {@link IPhrase} at the specified step.
     * 
    ...
    /**
     * Returns a List of all existing {@link ITrigger} instance found in the
     * {@link IPhrase} at the specified beat.
     * 
    ...
    void addPhraseListener(IPhraseListener value);
    ...
    public interface IPhraseListener
    {
         ...
         * @see IPhrase#setLength(int)
         */
        void onLengthChange(IPhrase phrase, int length);

        /**
         * Dispatched when the phrase position has changed.
         * 
         * @param phrase The IPhrase.
         * @see IPhrase#setPosition(int)
         */
        void onPositionChange(IPhrase phrase, int position);

        /**
         * Dispatched when the phrase resolution has changed.
         * 
         * @param phrase The IPhrase.
         * @see IPhrase#setResolution(com.teotigraphix.caustic.part.Resolution)
         */
        void onResolutionChange(IPhrase phrase, Resolution resolution);
