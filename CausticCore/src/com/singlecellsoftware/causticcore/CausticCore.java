...
class CausticAudioLoop extends Thread {
    ...
    CausticAudioLoop() {
        ...
        nativeSetProcessBufferSize(PROCESS_BUFFER_SIZE_BYTES / 4); // div by 2
                                                                   // for
                                                                   // stereo,
                                                                   // and by
                                                                   // 2 for 16
    ...
    public void run() {
        ...
        if (m_AudioTrack.getState() == AudioTrack.STATE_UNINITIALIZED) {
            Log.e("Caustic", "m_AudioTrack unititilaized, trying to run()");
            return;
        }
