...
public class TriggerMapUtils {
    ...
    static void contractResolution(TriggerMap phrase, Resolution oldValue, Resolution value) {
    ...
    static void expandResolution(TriggerMap phrase, Resolution oldValue, Resolution value) {
    ...
    static Trigger initializeNoteTrigger(TriggerMap phrase, float start, int pitch, float end,
     ...
     */
    static Trigger initializeStepTrigger(TriggerMap phrase, int step, int pitch, float gate,
            float velocity, int flags) {
