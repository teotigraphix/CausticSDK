...
public class MonoStepPhrase extends StepPhraseBase {
    ...
    public void addNote(int pitch, float start, float end, float velocity, int flags) {
        throw new IllegalStateException("MonoTriggerMap.addNote() not implemented");
    }

    @Override
    public void removeNote(int pitch, float start) {
        throw new IllegalStateException("MonoTriggerMap.removeNote() not implemented");
    }
    ...
    public void triggerOn(int step, int pitch, float gate, float velocity, int flags) {
        ...
        if (trigger == null)
            throw new IllegalStateException("Trigger must not be null in mono mode");
        ...
        PatternSequencerMessage.NOTE_DATA.send(getSequencer().getDevice().getEngine(),
                getSequencer().getDevice().getIndex(), start, pitch, velocity, end, flags);
    ...
    public void triggerOff(int step, int pitch) {
        ...
        PatternSequencerMessage.NOTE_DATA_REMOVE.send(getSequencer().getDevice().getEngine(),
                getSequencer().getDevice().getIndex(), start, trigger.getPitch());
