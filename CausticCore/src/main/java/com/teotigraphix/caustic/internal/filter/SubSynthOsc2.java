...
public class SubSynthOsc2 extends OscillatorComponent implements ISubSynthOsc2
{
    ...
    {
        return (int) SubSynthOscMessage.OSC2_CENTS.query(getEngine(),
                getMachineIndex());
    }
    ...
    public void setCents(int value)
    {
        ...
        if (value < -50 || value > 50)
            throw newRangeException(SubSynthOscMessage.OSC2_CENTS.toString(),
                    "-50..50", value);
        mCents = value;
        SubSynthOscMessage.OSC2_CENTS.send(getEngine(), getMachineIndex(),
                mCents);
    }
    ...
    {
        return (int) SubSynthOscMessage.OSC2_OCTAVE.query(getEngine(),
                getMachineIndex());
    }
    ...
    public void setOctave(int value)
    {
        if (value == mOctave)
            return;
        if (value < -3 || value > 3)
            throw newRangeException(SubSynthOscMessage.OSC2_OCTAVE.toString(),
                    "-3..3", value);
        mOctave = value;
        SubSynthOscMessage.OSC2_OCTAVE.send(getEngine(), getMachineIndex(),
                mOctave);
    }
    ...
    {
        return SubSynthOscMessage.OSC2_PHASE.query(getEngine(),
                getMachineIndex());
    }
    ...
    public void setPhase(float value)
    {
        ...
        if (value < -0.5f || value > 0.5f)
            throw newRangeException(SubSynthOscMessage.OSC2_PHASE.toString(),
                    "-0.5..0.5", value);
        mPhase = value;
        SubSynthOscMessage.OSC2_PHASE.send(getEngine(), getMachineIndex(),
                mPhase);
    }
    ...
    {
        return (int) SubSynthOscMessage.OSC2_SEMIS.query(getEngine(),
                getMachineIndex());
    }
    ...
    public void setSemis(int value)
    {
        ...
        if (value < -12 || value > 12)
            throw newRangeException(SubSynthOscMessage.OSC2_SEMIS.toString(),
                    "-12..12", value);
        mSemis = value;
        SubSynthOscMessage.OSC2_SEMIS.send(getEngine(), getMachineIndex(),
                mSemis);
    }
    ...
    {
        return WaveForm.toType(SubSynthOscMessage.OSC2_WAVEFORM.query(
    ...
    public void setWaveform(WaveForm value)
    {
        if (value == mWaveForm)
            return;
        mWaveForm = value;
        SubSynthOscMessage.OSC2_WAVEFORM.send(getEngine(), getMachineIndex(),
                mWaveForm.getValue());
    }
